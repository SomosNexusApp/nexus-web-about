...
const newStyle = `<style is:global>
      /* Force header to ALWAYS be dark and visible on this page */
      nav.site-nav {
      ...
      body {
        ...
        /* DO NOT override global text color here so header/footer stay intact */
      }
      ...
      .doc-layout {
        ...
        width: 100%;
        position: relative;
        color: var(--doc-text); /* Scope light text only to doc content */
      }

      /* Premium Sidebar */
      .sidebar {
        /* Width dynamically set via JS to exactly match nav-brand */
        ...
        padding: 3rem 2rem 3rem var(--container-pad);
        overflow-y: auto;
...
console.log('Success fixing header and alignment css');
